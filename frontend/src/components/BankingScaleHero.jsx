...
const stats = [
  {
    value: "5,000+",
    description: "Perritos reportados\nen nuestra plataforma",
    delay: 0,
  },
  {
    value: "1,200+",
    description: "Perritos adoptados\ncon éxito",
    delay: 0.2,
  },
  {
    value: "50+",
    description: "Refugios y rescatistas\ncolaborando",
    delay: 0.4,
  },
  {
    value: "10,000+",
      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Miles de perritos callejeros esperan{" "}
              <span
              ...
              >
                una segunda oportunidad gracias a personas como tú.
              </span>
            </h2>
            ...
            >
              Nuestra plataforma conecta a rescatistas, refugios y familias adoptivas para darle un hogar
              a cada perrito callejero. Reporta, comparte y salva vidas.
            </p>
